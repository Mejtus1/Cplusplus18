...
// - create static function called CompareStudents that takes in two Student objects as parameters and checks to see if their attributes (name and student_id) are same
// - if objects’ attributes are same, true is returned, otherwise, false is returned
...
// - compareStudents should be static since it is called using scope resolution operator :: in main
// - make sure CompareStudents takes in two Student objects
// - set up conditionals to compare attributes name and student_id of Student objects
// - if attributes are  same, return true, otherwise, return false
// - compareStudents can be either bool or string function as both will work with the code in main
